...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\NormalTok{opts\_chunk}\SpecialCharTok{$}\FunctionTok{set}\NormalTok{(}\AttributeTok{echo =}\NormalTok{ F,}\AttributeTok{warning=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{message=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{attr.source=}\StringTok{\textquotesingle{}.numberLines\textquotesingle{}}\NormalTok{,}\AttributeTok{attr.output=}\StringTok{\textquotesingle{}.numberLines\textquotesingle{}}\NormalTok{, }\AttributeTok{fig.align=}\StringTok{\textquotesingle{}center\textquotesingle{}}\NormalTok{, }\AttributeTok{dpi=}\DecValTok{350}\NormalTok{, }\AttributeTok{fig.width=}\DecValTok{12}\NormalTok{, }\AttributeTok{fig.height=}\DecValTok{12}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 16\tabcolsep) * \real{0.1875}}
...
\caption{Passwords Data Top 6 Observarions}\tabularnewline
\toprule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
1 & password & password-related & 6.91 & years & 2.17e+00 & 1 & 8 &
11 \\
...
{\centering \includegraphics{passwords_analysis_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
{\centering \includegraphics{passwords_analysis_files/figure-pdf/unnamed-chunk-5-1.pdf}
